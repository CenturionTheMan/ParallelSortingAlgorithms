...
namespace measurement {
     ...
     * 
     *  @return `solution_validation_data_t` that describes weather implementation has given valid solution or not
     */
     ...
     *  
     *  @return `solution_validation_data_t` that describes weather all implementations has given valid solutions or not
     */

...
data::results_t data::results_t::calculateMeanAndStandardDeviation(std::list<data::results_t> &results_from_repetitions, int instance_size)
{
    ...
    for (data::results_t results_from_repetition : results_from_repetitions) {
        average_result.cpu_bitonic_std_deviation += std::pow(
            results_from_repetition.cpu_bitonic_time_seconds - average_result.cpu_bitonic_time_seconds, 2
        );
        average_result.gpu_bitonic_std_deviation += std::pow(
            results_from_repetition.gpu_bitonic_time_seconds - average_result.gpu_bitonic_time_seconds, 2
        );
        average_result.cpu_odd_even_std_deviation += std::pow(
            results_from_repetition.cpu_odd_even_time_seconds - average_result.cpu_odd_even_time_seconds, 2
        );
        average_result.gpu_odd_even_std_deviation += std::pow(
            results_from_repetition.gpu_odd_even_time_seconds - average_result.gpu_odd_even_time_seconds, 2
        );
    }
    average_result.gpu_bitonic_std_deviation = std::sqrt(average_result.gpu_bitonic_std_deviation / results_from_repetitions.size());
    average_result.cpu_bitonic_std_deviation = std::sqrt(average_result.cpu_bitonic_std_deviation / results_from_repetitions.size());
    average_result.cpu_odd_even_std_deviation = std::sqrt(average_result.cpu_odd_even_std_deviation / results_from_repetitions.size());
    average_result.gpu_odd_even_std_deviation = std::sqrt(average_result.gpu_odd_even_std_deviation / results_from_repetitions.size());
